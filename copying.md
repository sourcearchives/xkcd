...
The typefaces embedded in [_xkcd: volume 0_](./content/en/print/xkcd_volume_0/) are Liberation Serif and Tahoma version. Some other fonts are also used in the book, whose machine-readable licenses do not permit embedding into documents.
